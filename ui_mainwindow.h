...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Curve Editor", 0, 0));
        actionClear_Scene->setText(QApplication::translate("MainWindow", "Clear Scene", 0, 0));
        actionTool_Bar->setText(QApplication::translate("MainWindow", "Tool Bar", 0, 0));
        actionStatus_bar->setText(QApplication::translate("MainWindow", "Status bar", 0, 0));
        actionAbout->setText(QApplication::translate("MainWindow", "About Curve Editor...", 0, 0));
        actionShow_Control_Points->setText(QApplication::translate("MainWindow", "Show Control Points", 0, 0));
        actionShow_Curve_Points->setText(QApplication::translate("MainWindow", "Show Curve Points", 0, 0));
        menuScene->setTitle(QApplication::translate("MainWindow", "Scene", 0, 0));
        menuView->setTitle(QApplication::translate("MainWindow", "View", 0, 0));
        menuHelp->setTitle(QApplication::translate("MainWindow", "Help", 0, 0));
