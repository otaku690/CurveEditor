...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Curve Editor", 0, 0));
#ifndef QT_NO_TOOLTIP
        AboutDialog->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        pushButton->setText(QApplication::translate("AboutDialog", "OK", 0, 0));
        label->setText(QApplication::translate("AboutDialog", "Curve Editor Version 2.0", 0, 0));
        label_2->setText(QApplication::translate("AboutDialog", "Copyright (C) 2011", 0, 0));
        label_3->setText(QApplication::translate("AboutDialog", "University of Pennsylvania", 0, 0));
        Name->setText(QApplication::translate("AboutDialog", "Updated by Tiju Thomas", 0, 0));
        label_Help1_2->setText(QApplication::translate("AboutDialog", "---------------------------------------------------------", 0, 0));
        label_Help1->setText(QApplication::translate("AboutDialog", "* Right Click on a Curve Point to add", 0, 0));
        label_Help2->setText(QApplication::translate("AboutDialog", "an Interpolation Point on the curve", 0, 0));
        label_Help3->setText(QApplication::translate("AboutDialog", "* Right Click on an Interpolation point to delete it", 0, 0));
